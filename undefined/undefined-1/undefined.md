...
로니클럽 서비스는 유저가 NFT 콘텐츠를 손쉽게 생성할 수 있는 CIY 툴을 제공합니다. CIY 툴을 활용해, 유저는 이미지 파일을 업로드하고 파츠 NFT(상의, 하의, 장갑, 마스크, 모자, 신발, 액세서리)를 발행할 수 있습니다. 또한, 생성한 파츠 NFT를 합성해서 최종적으로 1장의 합성 NFT를 발행할 수 있습니다.
